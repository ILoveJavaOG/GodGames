...
public class API_CraftTitleApi implements Listener {
	...
	public API_CraftTitleApi(Lobby main) {
		this.main = main;
	}
  ...
  public static void sendTitle(Player player, Integer fadeIn, Integer stay, Integer fadeOut, String title, String subtitle) {
    API_TitleSendEvent titleSendEvent = new API_TitleSendEvent(player, title, subtitle);
...
public static void clearTitle(Player player) {
  ...
  public static void sendTabTitle(Player player, String header, String footer) {
    ...
    API_TitleSendEvent tabTitleSendEvent = new API_TitleSendEvent(player, header, footer);
